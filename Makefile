...
test racer-test: $(TRACK_TEST) $(TRACK_PROGRESS_GRAPH_TEST) $(RACE_PHYSICS_TEST) $(VEHICLE_DYNAMICS_TEST) $(GHOST_REPLAY_TEST) $(TIME_TRIAL_TEST) $(TRACK_POSITION_TEST) $(CHECKPOINT_RECOVERY_TEST) $(PLAYABLE_IO_TEST) $(MAIN_MENU_FLOW_TEST) $(PIECE_CATALOG_TEST) $(REPOSITORY_HARDENING_TEST)
	./$(TRACK_TEST)
